...
oaApp.controller("htNg${firstModuleName}${firstComponentName}Ctrl", function($scope, $controller, $htNg${firstModuleName}01Manager,
    ...
    $scope.${modalName}${componentName}Model.newModel = {};//
    ...
    $scope.listRefresh = function() {
        ...
        //$htNg${firstModuleName}${firstComponentName}Manager.fetch${firstModuleName}List($scope.queryModel, '', callback, $scope.${modalName}Model.pageSelectorCtrl);
    };
    //获取id字符串

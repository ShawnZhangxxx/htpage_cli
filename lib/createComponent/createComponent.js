        ...
        childAry: [{
            name: `CN`,
                ...
                <div class="modal-content" ng-style="showLocationStyle" drag>
                    ...
                    <div class=" p-l-10 p-r-10  p-t-20 ${moduleName}_flex_y">
                    <div class="${moduleName}_flex h-40">
                    <div class="w-100">
                    ...
                    <div class="${moduleName}_flex h-40">
                    <div class="w-100">
                        <ht-ng-label-direct message={{'区域'}}>
                        </ht-ng-label-direct>
                    </div>
                    <div>
                        <htng-input-direct text-show-value="addressModel.area"  input-width="240">
                        </htng-input-direct>
                    </div>
                </div>
                </div>
